    ...
    <>
      <MainLayout fullWidth={true}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
          {/* Profile Header Card */}
          <div className="rounded-3xl bg-white/5 border border-white/10 p-4 md:p-8 mb-6">
            <div className="flex flex-col md:flex-row gap-6 md:gap-8">
              {/* Profile Image */}
              <div className="flex justify-center md:justify-start">
                <div className="w-28 h-28 md:w-40 md:h-40 rounded-full overflow-hidden flex-shrink-0 border-4 border-white/10">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div className="text-center md:text-left">
                    <div className="flex flex-col md:flex-row items-center md:items-center gap-3 mb-2">
                      ...
                      <span className="px-2.5 py-1 bg-blue-500/20 text-blue-400 text-xs font-bold rounded-full border border-blue-500/40">
                        VERIFIED
                      </span>
                    </div>
                    <div className="flex items-center justify-center md:justify-start gap-2 text-white/80 text-sm mb-1.5">
                  ...
                  <button
                    ...
                    className="w-full md:w-auto px-5 py-2.5 bg-white/10 hover:bg-white/20 border border-white/20 rounded-full text-sm font-bold transition-all flex items-center justify-center gap-2 hover:scale-105 active:scale-95"
                  >
                ...
                {/* Stats */}
                <div className="flex items-center justify-center md:justify-start gap-8 py-4 border-y border-white/10">
                  <div className="text-center">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 px-5 py-3 bg-white text-black rounded-full text-sm font-bold hover:bg-gray-100 transition-all transform hover:scale-105 active:scale-95 flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="px-5 py-3 bg-white/10 hover:bg-white/20 border border-white/20 rounded-full font-bold transition-all flex items-center justify-center"
                  >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="rounded-2xl bg-white/5 border border-white/10 p-4 md:p-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {profile.lifestyles.map((lifestyle: string, idx: number) => (
                    <div
                      key={idx}
                      className="px-4 py-3 bg-white/10 border border-white/20 rounded-xl flex items-center gap-3 hover:bg-white/20 transition"
                    >
            ...
            <div className="space-y-6">
              ...
              {/* Verification */}
              <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-2xl border-2 border-blue-500/40 p-4 md:p-6">
