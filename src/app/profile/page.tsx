  ...
  return (
    <MainLayout>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="bg-gradient-to-b from-white/10 to-white/5 rounded-3xl border border-white/20 p-6 md:p-8 mb-6">
          <div className="flex flex-col md:flex-row gap-6">
            {/* Profile Image */}
            <div className="relative flex-shrink-0">
              <div className="relative w-32 h-32 md:w-40 md:h-40 mx-auto md:mx-0">
                <div className="w-full h-full rounded-3xl bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center border-4 border-white/20">
